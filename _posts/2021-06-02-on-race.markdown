...
Race was invented as a way to categorize groups of humans (and by extension, individuals) based on physical and social characteristics. [@smedleyRaceBiologyFiction2005, p. 3] The meaning of race, such as the perceptions and stereotypes assigned to different races, and the categories of racial groups are continually changing and are contingent on the social context of a particular time and place. Two aspects of race include:
